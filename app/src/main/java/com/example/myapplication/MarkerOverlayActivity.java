...
public class MarkerOverlayActivity extends Activity {
    ...
    public void init() {
        ...
        BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.node_red_01);
        ...
        BitmapDescriptor iconb = BitmapDescriptorFactory.fromResource(R.drawable.node_red_02);
        options.position(ssd)//位置
                .title("ssd")//titile
                .icon(iconb);     //图标
        baiduMap.addOverlay(options);

        BitmapDescriptor iconc = BitmapDescriptorFactory.fromResource(R.drawable.node_red_10);
